    ...
    <nav id="menu" class="main-nav" role="navigation">
      <ul class="main-menu">
        ...
        <li class="has-submenu"><a href="#section2">LogIn</a>
          <ul class="sub-menu">
        <li><a href="login_signup_student.php">Student</a></li>
        ...
        <div class="col-md-5">
          <div class="right-content">
            <div class="top-content">
              <h6>Register your free account and <em>get immediate</em> access to our platform</h6>
            </div>
            <form id="contact" action="" method="get">
              <div class="row">
                ...
                <div class="col-md-12">
                  <fieldset>
                    <input name="id-number" type="text" class="form-control" id="id-number" placeholder="Your ID Number *" required="">
                  </fieldset>
                </div>
                <div class="col-md-12">
                  <fieldset>
                    <input name="password" type="password" class="form-control" id="pass" placeholder="Create Password *" required="">
                  </fieldset>
                </div>
                <div class="col-md-12">
                  <fieldset>
                    <input name="password" type="password" class="form-control" id="pass" placeholder="Confirm Password *" required="">
                  </fieldset>
                </div>
                <div class="col-md-12">
                  <fieldset>
